$(function(){
	...
	$('.erji_2 li').hover(function() {
		...
		$('.plate80_1_r').children('.span1').hover(function(){
			$('.plate80_1_r').children('.span2').css('display','block')
		},function(){
			$('.plate80_1_r').children('.span2').css('display','none')
		})
	
		$('.plate80_2_box4').hover(function(){
			$('.plate80_2_box4_ewm').css('display','block')
		},function(){
			$('.plate80_2_box4_ewm').css('display','none')
		})
